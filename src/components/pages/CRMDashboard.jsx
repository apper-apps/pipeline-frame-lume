...
const getColumnColor = (column) => {
    ...
    <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        ...
        <div className="text-sm text-gray-600">Showing {filteredLeads.length}of {leads.filter(l => !l.archived).length}leads
                      </div>
    </div>
    {/* Table */}
    <div
            ...
            <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th className="px-6 py-4 text-left text-sm font-medium text-gray-900">Contact Info
                                              </th>
                        <th
                            className="px-6 py-4 text-left text-sm font-medium text-gray-900 cursor-pointer hover:bg-gray-100 transition-colors"
                            onClick={() => handleSort("column")}>
                            <div className="flex items-center gap-2">Stage
                        ...
                        <th className="px-6 py-4 text-center text-sm font-medium text-gray-900">Actions
                                              </th>
                    </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                    {filteredLeads.map(lead => <tr key={lead.Id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                            <span
                                className={`px-2 py-1 rounded-full text-xs font-medium ${getColumnColor(lead.column)}`}>
                                {lead.column}
                            </span>
                        </td>
                        <td className="px-6 py-4">
