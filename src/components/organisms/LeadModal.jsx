    ...
    {isOpen && <motion.div
        ...
        <motion.div
            ...
            <div className="bg-gradient-to-r from-primary to-blue-600 p-6 text-white">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-blue-100 mt-1 text-sm">
                            {lead ? "Update lead information" : "Create a new lead in your pipeline"}
                        </p>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                <button
                    onClick={handleClose}
                    className="text-blue-100 hover:text-white p-2 hover:bg-white/10 rounded-lg transition-colors">
                    <ApperIcon name="X" size={20} />
                </button>
            </div>
                ...
                <div className="grid grid-cols-1 gap-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            <label className="block text-sm font-semibold text-gray-700">Stage <span className="text-red-500">*</span>
                            </label>
                            <select
                                name="column"
